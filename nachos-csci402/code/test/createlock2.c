...
main()
{
    ...
    int i;
   	...
   	Printx("\nTest2 is creating another lock named lock1\n",46,1);
   	...
   	name = "lock2";
   	Printx("\nTest2 is creating another lock named lock2\n",47,1);
   	lock3 = CreateLock(name, 5);
   	if(lock3 == -1){
   		Printx("Lock2 not created\n",19,1);
   	}
   	else {
   		Printx("Lock2 created successfully at index %d%d\n",41,lock3*10000);	
   	}
